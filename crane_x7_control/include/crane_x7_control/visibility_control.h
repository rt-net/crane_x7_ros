...
#define CRANE_X7_CONTROL_PUBLIC ROS2_CONTROL_DEMO_HARDWARE_EXPORT
#else
#define CRANE_X7_CONTROL_PUBLIC ROS2_CONTROL_DEMO_HARDWARE_IMPORT
#endif
#define CRANE_X7_CONTROL_PUBLIC_TYPE ROS2_CONTROL_DEMO_HARDWARE_PUBLIC
